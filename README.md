...
2. If you want to login into staff (financial, system admin or stall) application, then type "http://localhost/online-meal-ordering-system/meal-ordering-app/staff_login.php", or click on the link "Staff?Click Here"
